...
export const config: Config = {
    nodeEnv: env,
    gameType: parseInt(getEnvVar('GAME_TYPE', '1'), 10),
    gameTypeKey: getEnvVar('GAME_TYPE_KEY', 'ARROWS'),
    database: {
    ...
    redis: {
        ...
        arrowsProjectKey: getEnvVar('REDIS_ARROWS_PROJECT_KEY'),
    ...
    swagger: {
        title: getEnvVar('PROJECT_NAME', 'Arrows Game Service'),
        description: getEnvVar('PROJECT_DESCRIPTION', 'Arrows Game Service API'),
    ...
    otel: {
        serviceName: getEnvVar('OTEL_SERVICE_NAME', 'arrows-backend'),
