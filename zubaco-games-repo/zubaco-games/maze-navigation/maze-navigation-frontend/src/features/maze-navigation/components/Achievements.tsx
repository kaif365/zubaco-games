...
const ACHIEVEMENTS: Achievement[] = [
  { id: 'FIRST_WIN', title: 'First Victory', description: 'Solve your first maze', icon: '🏆' },
  { id: 'STREAK_5', title: 'On Fire', description: 'Solve 5 mazes in a row', icon: '🔥' },
  ...
  { id: 'NO_MISTAKES', title: 'No Dead Ends', description: 'Complete without hitting walls', icon: '✨' },
];

// ─── Storage ─────────────────────────────────────────────────────────────────

const STORAGE_KEY = 'maze-navigation-achievements';
...
export function checkAchievements(context: {
  ...
  const checks: [AchievementId, boolean][] = [
    ...
    ['NO_MISTAKES', context.noWallHits === true],
  ];
