...
const MENU_ITEMS = [
  ...
  { key: 'levels', label: 'Levels', icon: '📐', accent: 'from-purple-600 to-purple-700' },
  ...
  return (
    <div className="fixed inset-0 z-40 flex flex-col items-center justify-center bg-slate-950 p-6">
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-white tracking-wide">Logic Reflector</h1>
        <p className="mt-1 text-sm text-slate-400">Guide the laser to all targets</p>
      </motion.div>
