...
const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: AchievementId.PERFECT_GAME, title: "Perfectionist", description: "Complete a game with minimum moves", icon: "💎", xp: 200 },
...
const STORAGE_KEY = "infinity-loop-achievements";

function loadProgress(): AchievementProgress[] {
  if (typeof window === "undefined") return ACHIEVEMENTS.map((a) => ({ id: a.id, unlocked: false, unlockedAt: null }));
  try {
