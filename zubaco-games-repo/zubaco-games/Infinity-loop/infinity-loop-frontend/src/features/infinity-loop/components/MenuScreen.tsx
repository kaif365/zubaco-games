...
const MENU_BUTTONS = [
  { key: "play", label: "Play", icon: "▶️", color: "from-emerald-600 to-emerald-700" },
  ...
  { key: "achievements", label: "Achievements", icon: "🏆", color: "from-blue-600 to-blue-700" },
  ...
  return (
    <div className="fixed inset-0 z-40 flex flex-col items-center justify-center bg-slate-950 p-6">
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-white tracking-tight">Infinity Loop</h1>
        <p className="mt-1 text-sm text-slate-400">Relaxing loop puzzle</p>
      </motion.div>
