...
export function PauseDialog({ score, wrongTaps, elapsedMs, onResume, onRestart, onExit }: PauseDialogProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      ...
      >
        ...
        <div className="space-y-2 mb-6">
          ...
          <div className="text-gray-400 text-sm">
            Mistakes: <span className="text-red-400 font-semibold">{wrongTaps}/2</span>
          </div>
          <div className="text-gray-400 text-sm">
