  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-b from-gray-900 via-gray-900 to-gray-950">
      ...
      >
        ...
        <h1 className="text-3xl font-black text-white tracking-tight">Reflex Endurance</h1>
        <p className="text-gray-400 text-sm">Tap the green circles — avoid the rest!</p>
      </motion.div>
