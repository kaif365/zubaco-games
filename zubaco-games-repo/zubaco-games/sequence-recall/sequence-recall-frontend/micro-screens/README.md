...
These URLs belong to **this repo’s React.js app** so you can preview layouts locally. They are **not** meant as production routes—mount the components wherever your product needs them.
