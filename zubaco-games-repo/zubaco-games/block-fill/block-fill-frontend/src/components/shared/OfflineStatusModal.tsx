import '@micro-screens/src/section/instructions/instructions-screen.css';
...
export function OfflineStatusModal() {
  ...
  return (
    <Dialog open={isModalOpen}>
      <div
        className={cn(
          'relative rounded-xl border !border-white/10 bg-transparent text-card-foreground backdrop-blur',
          'overflow-hidden rounded-[18px] border border-amber-400/30 shadow-[0_24px_60px_rgba(0,0,0,0.55)]',
          'text-[hsl(210_40%_98%)]',
        )}
      ...
      >
        ...
        <div className={cn('p-5 pt-0 pb-0', 'flex flex-col gap-4 p-5 sm:p-6')}>
