...
interface InstructionsSkeletonProps {
  stage: StageId;
  className?: string;
}

export function InstructionsSkeleton({ stage, className }: InstructionsSkeletonProps) {
  ...
  return (
    <div className="instructionViewport">
      ...
      >
        ...
        <div className="eclipse" style={{ '--eclipse-color': theme.eclipse } as CSSProperties} />
