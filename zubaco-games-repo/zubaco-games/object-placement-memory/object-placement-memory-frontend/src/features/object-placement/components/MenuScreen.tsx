...
const buttons = [
  { key: 'play', label: '▶ Play', color: 'bg-indigo-600 hover:bg-indigo-500' },
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 gap-6">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center">
        <h1 className="text-4xl font-bold mb-2">🧩 Object Placement</h1>
        <p className="text-gray-400 text-sm">Remember where each object belongs!</p>
      </motion.div>
