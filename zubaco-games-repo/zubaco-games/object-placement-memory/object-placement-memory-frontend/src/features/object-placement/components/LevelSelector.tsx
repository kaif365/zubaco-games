...
export function LevelSelector({ onSelect, onBack }: Props) {
  ...
  const configs = ['4×4 3obj', '4×4 4obj', '5×5 5obj', '5×5 5obj', '5×5 6obj', '6×6 7obj', '6×6 8obj', '6×6 9obj', '7×7 10obj', '7×7 12obj'];
        ...
        {levels.map((lvl, i) => (
          <motion.button
            ...
            className={`aspect-square rounded-xl flex flex-col items-center justify-center text-sm font-bold border-2 transition-colors
              ${lvl.unlocked ? 'bg-indigo-700 border-indigo-500 hover:bg-indigo-600' : 'bg-gray-800 border-gray-700 opacity-50'}`}
          >
            {lvl.unlocked ? (
              <>
