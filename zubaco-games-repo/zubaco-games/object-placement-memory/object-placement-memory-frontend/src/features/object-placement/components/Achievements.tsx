...
const STORAGE_KEY = 'object-placement-achievements';
...
const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'STREAK_5', title: 'On Fire', description: '5 correct placements in a row', icon: '🔥' },
  { id: 'STREAK_10', title: 'Unstoppable', description: '10 correct placements streak', icon: '⚡' },
  { id: 'PERFECT_GAME', title: 'Perfectionist', description: 'Place all objects correctly', icon: '💎' },
  ...
  { id: 'HIGH_SCORER', title: 'High Scorer', description: 'Score over 100 points', icon: '📈' },
