...
const mockResponse = {
  entries: [
    { rank: 1, playerId: 'p1', playerName: 'Alice', score: 9800, gamesPlayed: 12 },
    { rank: 2, playerId: 'p2', playerName: 'Bob', score: 8500, gamesPlayed: 10 },
  ],
  total: 2,
  page: 1,
  pageSize: 10,
...
describe('useLeaderboard', () => {
  ...
  it('handles API errors', async () => {
    mockLeaderboardApi.getLeaderboard.mockRejectedValue(new Error('Network error'));
