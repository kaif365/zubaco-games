...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('True False Blitz API')
    .setDescription('ZUBACO Gaming Engine - True False Blitz Microservice')
    .setVersion('1.0')
    .addBearerAuth()
    .build();
  ...
  console.log(`True/False Blitz backend running on port ${appConfig.port} | API: /api/v1`);
}
bootstrap();
