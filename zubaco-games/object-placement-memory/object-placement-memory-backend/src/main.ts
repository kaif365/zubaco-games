...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Object Placement Memory API')
    .setDescription('ZUBACO Gaming Engine - Object Placement Memory Microservice')
    .setVersion('1.0')
    .addBearerAuth()
    .build();
  ...
  console.log(`Object Placement Memory backend running on port ${appConfig.port} | API: /api/v1`);
}
bootstrap();
