...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Speed Type Answer API')
    .setDescription('ZUBACO Gaming Engine - Speed Type Answer Microservice')
    .setVersion('1.0')
    .addBearerAuth()
    .build();
  ...
  console.log(`Speed Type Answer backend running on port ${appConfig.port} | API: /api/v1`);
}
bootstrap();
