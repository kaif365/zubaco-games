...
const MENU_BUTTONS: { label: string; phase: AppPhase; color: string; icon: string }[] = [
  { label: 'Play', phase: 'game', color: 'from-indigo-600 to-indigo-700', icon: '⌨️' },
  { label: 'Levels', phase: 'levels', color: 'from-violet-600 to-violet-700', icon: '📊' },
  { label: 'Daily Challenge', phase: 'daily', color: 'from-amber-600 to-amber-700', icon: '📅' },
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-b from-gray-900 via-gray-900 to-gray-950">
      ...
      >
        ...
        <h1 className="text-3xl font-black text-white tracking-tight">Speed Type</h1>
        <p className="text-gray-400 text-sm">Flash, memorize, type the answer!</p>
      </motion.div>
