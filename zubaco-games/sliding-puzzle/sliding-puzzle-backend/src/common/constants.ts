...
export const GAME_CONFIGS = {
    // next-board has no unlock threshold — can be called at any point during a board
...
export const ANTI_CHEAT_CONFIGS = {
    CLICK_TOO_FAST_MS: 50, // minimum ms between consecutive moves
    ...
    IMPOSSIBLE_SOLVE_MS_PER_PIECE: 100, // solved faster than N ms × piece count = flagged
} as const;
...
export const CHEAT_FLAG_TYPE = {
    CLICK_TOO_FAST: 1,
    UNIFORM_TIMING: 2,
    REMAINING_PIECES_AT_END: 3, // FE claimed solved (endBoard in STARTED) but puzzle incomplete
...
export const RESTATE_SERVICES = {
    GAME_EXPIRY: 'SlidingPuzzleGameExpiryRestateService',
    GAME_SESSION: 'SlidingPuzzleGameSessionRestateObject',
} as const;
