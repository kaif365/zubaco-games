...
const MESSAGES: Record<string, Record<string, string>> = {
    en: {
        ...
        INVALID_INTEGER_RANGE: 'One or more numeric values are outside the supported range',
        ...
        GAME_SESSION_RECOVERY_REQUIRED: 'Game session is active but recovery state is unavailable',
        ...
        ROUND_NUMBER_EXCEEDS_TOTAL_ROUNDS: 'Round number exceeds total rounds configured',
