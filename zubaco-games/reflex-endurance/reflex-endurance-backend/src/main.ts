...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Reflex Endurance API')
    .setDescription('ZUBACO Gaming Engine - Reflex Endurance Microservice')
    .setVersion('1.0')
    .addBearerAuth()
    .build();
  ...
  console.log(`Reflex Endurance backend running on port ${appConfig.port} | API: /api/v1`);
}
bootstrap();
