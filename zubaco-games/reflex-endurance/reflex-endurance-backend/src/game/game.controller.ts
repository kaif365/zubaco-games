...
export class GameController {
  ...
  @Post('submit') async submit(@Body() dto: SubmitGameDto, @Req() req: any) { return this.gameService.submitGame(req.user.sub || req.user.userId, dto.gameSessionId, dto.taps, dto.clientScore); }
}
