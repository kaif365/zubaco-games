...
const STORAGE_KEY = 'reflex-endurance-achievements';
...
const ACHIEVEMENT_DEFS: Omit<Achievement, 'unlocked'>[] = [
  ...
  { id: 'STREAK_5', title: 'On Fire', description: 'Tap 5 greens in a row', icon: '🔥' },
  { id: 'STREAK_10', title: 'Unstoppable', description: 'Tap 10 greens in a row', icon: '⚡' },
  { id: 'PERFECT_GAME', title: 'Perfectionist', description: 'Complete without any wrong taps', icon: '💎' },
  ...
  { id: 'HIGH_SCORER', title: 'High Scorer', description: 'Score over 100 in one game', icon: '📈' },
  { id: 'NO_MISTAKES', title: 'NO_MISTAKES', description: 'Zero wrong taps in a full game', icon: '✨' },
];
...
export function checkAndUnlockAchievements(params: {
  ...
  const checks: [string, boolean][] = [
    ...
    ['PERFECT_GAME', params.wrongTaps === 0],
    ...
    ['HIGH_SCORER', params.score >= 100],
    ['NO_MISTAKES', params.wrongTaps === 0],
  ];
