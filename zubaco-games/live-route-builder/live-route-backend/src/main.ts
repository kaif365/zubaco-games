...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Live Route Builder API')
    .setDescription('ZUBACO Gaming Engine - Live Route Builder Microservice')
    .setVersion('1.0')
    .addBearerAuth()
    .build();
  ...
  console.log(`Live Route backend running on port ${appConfig.port} | API: /api/v1`);
}
bootstrap();
