...
class PlainConsoleMetricExporter implements PushMetricExporter {
    ...
    selectAggregationTemporality(instrumentType: InstrumentType): AggregationTemporality {
        return new ConsoleMetricExporter().selectAggregationTemporality(instrumentType);
    }
...
const { serviceName, exporterEndpoint: endpoint } = config.otel;
...
const makeSpanExporter = (): SpanExporter => {
    ...
    return plainTextLogs ? new PlainConsoleSpanExporter() : new ConsoleSpanExporter();
};
...
const makeLogExporter = (): LogRecordExporter => {
    ...
    return plainTextLogs ? new PlainConsoleLogRecordExporter() : new ConsoleLogRecordExporter();
};
...
const makeMetricExporter = (): PushMetricExporter => {
    ...
    return plainTextLogs ? new PlainConsoleMetricExporter() : new ConsoleMetricExporter();
};
