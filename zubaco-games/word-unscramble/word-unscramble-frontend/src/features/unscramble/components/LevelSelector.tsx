...
const wordLevelConfigs = [
  { wordLength: '3-4 letters', timePerWord: '8s' },
  { wordLength: '4-5 letters', timePerWord: '7s' },
  { wordLength: '4-5 letters', timePerWord: '6.5s' },
  { wordLength: '5-6 letters', timePerWord: '6s' },
  { wordLength: '5-6 letters', timePerWord: '5.5s' },
  { wordLength: '6-7 letters', timePerWord: '5s' },
  { wordLength: '6-7 letters', timePerWord: '4.5s' },
  { wordLength: '7-8 letters', timePerWord: '4s' },
  { wordLength: '7-8 letters', timePerWord: '3.5s' },
  { wordLength: '8+ letters', timePerWord: '3s' },
];
            ...
            return (
              ...
              >
                ...
                <p className="text-[11px] text-gray-500">
                  {wordLevelConfigs[i].wordLength} · {wordLevelConfigs[i].timePerWord}/word
                </p>
                {!isLocked && (
