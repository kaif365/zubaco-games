...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Number Grid Sprint API')
    .setDescription('ZUBACO Gaming Engine - Number Grid Sprint Microservice')
    .setVersion('1.0')
    .addBearerAuth()
    .build();
  ...
  console.log(`Number Grid backend running on port ${appConfig.port} | API: /api/v1`);
}
bootstrap();
