...
const MENU_BUTTONS: { label: string; phase: AppPhase; color: string; icon: string }[] = [
  { label: 'Play', phase: 'game', color: 'from-purple-600 to-purple-700', icon: '🎮' },
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-b from-gray-900 via-gray-900 to-gray-950">
      ...
      >
        ...
        <h1 className="text-3xl font-black text-white tracking-tight">Rapid Category Sort</h1>
        <p className="text-gray-400 text-sm">Sort items fast before time runs out!</p>
      </motion.div>
