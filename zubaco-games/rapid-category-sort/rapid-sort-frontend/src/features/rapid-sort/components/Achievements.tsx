...
const STORAGE_KEY = 'rapid-sort-achievements';
...
const ACHIEVEMENT_DEFS: Omit<Achievement, 'unlocked'>[] = [
  ...
  { id: 'STREAK_5', title: 'On Fire', description: 'Achieve a 5-item streak', icon: '🔥' },
  { id: 'STREAK_10', title: 'Unstoppable', description: 'Achieve a 10-item streak', icon: '⚡' },
  { id: 'PERFECT_GAME', title: 'Perfectionist', description: 'Complete a game with 100% accuracy', icon: '💎' },
  ...
  { id: 'NO_MISTAKES', title: 'NO_MISTAKES', description: 'Complete without any mistakes or misses', icon: '✨' },
];
...
export function checkAndUnlockAchievements(params: {
  ...
  const checks: [string, boolean][] = [
    ...
    ['PERFECT_GAME', params.accuracy >= 100],
    ...
    ['NO_MISTAKES', params.wrongCount === 0 && params.missedCount === 0],
  ];
