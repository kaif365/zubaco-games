...
- No source file should exceed **400 lines** of code; split into smaller components, hooks, and modules as needed.
- Prefer a **component-based** architecture—compose features from focused pieces rather than monolithic files.

See **[DEVELOPMENT_GUIDE.md](./DEVELOPMENT_GUIDE.md)** (Coding Standards) for full conventions.
