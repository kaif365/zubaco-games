  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <p className="text-sm text-gray-400 mt-1">Navigate the maze before time runs out</p>
      </div>
              ...
              {isUnlocked && (
                <>
                  <div className="text-[10px] text-gray-500 mt-1 leading-tight">
                    {config.cols}×{config.rows} · {config.rounds} round{config.rounds > 1 ? 's' : ''} · {config.timeLimitSec}s
                  </div>
